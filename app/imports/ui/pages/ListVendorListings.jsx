...
import { Container, Header, Divider, Form, Button, Card, Loader } from 'semantic-ui-react';
...
class ListVendorListings extends React.Component {
  ...
  renderPage() {
    return (
        <div className="peach">
          <Container>
            <Header as="h2" textAlign="center" className="Montserrat">FOOD OPTIONS FOR THIS VENDOR</Header>
            <Divider/>
            <SearchInstructions/>
...
export default withTracker(({ match }) => {
  ...
  if (undefined === vendor[0]) {
    vendor[0] = {
      owner: 'kamitoku@foo.com',
        name: 'Kamitoku Ramen',
        description:
            'Kamitoku Ramen specializes in a Tottori-style beef bone ' +
            'ramen with a surplus amount of seasoning to sastisfy all needs .',
        image: 'http://manoa.hawaii.edu/food/index_files/stacks_image_1880.png',
    };
  }
  // console.log(vendor[0]);
  const menu = MenuItems.find({ owner: vendor[0].owner }).fetch();
