...
import FoodListingsAdmin from '../pages/FoodListingsAdmin';
        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <AdminProtectedRoute path="/adminVendors" component={FoodListingsAdmin}/>
              ...
              <AdminProtectedRoute path="/users" component={ListTableAccountsAdmin}/>
